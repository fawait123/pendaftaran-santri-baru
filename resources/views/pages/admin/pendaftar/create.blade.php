            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center">Tambah Pendaftaran</h5>
                    </div>
                    <form class="form theme-form" method="post" action="{{ route('admin.pendaftar.store') }}"
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('tgl_lahir') is-invalid @enderror" id="tgl_lahir"
                                            type="date" value="{{ old('tgl_lahir') }}" placeholder="Tanggal Lahir"
                                            name="tgl_lahir">
                                        @error('tgl_lahir')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('anak_ke') is-invalid @enderror" id="anak_ke"
                                            type="text" value="{{ old('anak_ke') }}" placeholder="Anak Ke"
                                            name="anak_ke">
                                        @error('anak_ke')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('nik') is-invalid @enderror" id="nik"
                                            type="text" value="{{ old('nik') }}" placeholder="No Induk Keluarga"
                                            name="nik">
                                        @error('nik')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('no_hp') is-invalid @enderror" id="no_hp"
                                            type="text" value="{{ old('no_hp') }}" placeholder="NO HP"
                                            name="no_hp">
                                        @error('no_hp')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('nik_ibu') is-invalid @enderror" id="nik_ibu"
                                            type="text" value="{{ old('nik_ibu') }}" placeholder="NIK Ibu"
                                            name="nik_ibu">
                                        @error('nik_ibu')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
