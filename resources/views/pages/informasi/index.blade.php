                        ...
                        <section class="cd-container" id="cd-timeline">
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    ...
                                    <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto,
                                        optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad
                                        debitis unde? Iste voluptatibus minus veritatis qui ut.</p><span class="cd-date">Jan
                                        <span class="counter"> 14</span></span>
                                </div>
                            </div>
                            <div class="cd-timeline-block">
                            ...
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    <h4>Title of section<span> 3</span></h4><img class="img-fluid p-t-20"
                                        src="../assets/images/banner/1.jpg" alt=""><span class="cd-date">Jan <span
                            ...
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    ...
                                    <audio class="m-t-20" controls="">
                                        <source src="../assets/audio/horse.ogg" type="audio/ogg"> Your browser does not
                            ...
                            <div class="cd-timeline-block">
                                ...
                                <div class="cd-timeline-content">
                                    <h4>Title of section<span> 5</span></h4><img class="img-fluid p-t-20"
                                        src="../assets/images/banner/3.jpg" alt=""><span class="cd-date">Feb <span
